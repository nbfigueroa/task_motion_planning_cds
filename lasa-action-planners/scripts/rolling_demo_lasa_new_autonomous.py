...
def SendGoals2MotionPlanner(desired_action):
	...
	while area < desired_dough_area and num_rolls<max_rolls:	     	      
		...
		result = send_goal(desired_action, 'reach', object_frame, reach, "", 10, haptic_type, hyper_param)
		print "\n\n= = = = Starting reaching phase = = = = = "
		print "Result:"		
		print result.success

		result = send_goal(desired_action, 'roll', object_frame, roll, force_gmm_id, 10, haptic_type, hyper_param)
